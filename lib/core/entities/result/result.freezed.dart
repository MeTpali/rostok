...
class __$$ErrorResultImplCopyWithImpl<T, $Res>
  ...
  __$$ErrorResultImplCopyWithImpl(
    _$ErrorResultImpl<T> _value,
    $Res Function(_$ErrorResultImpl<T>) _then,
  ) : super(_value, _then);
...
class _$ErrorResultImpl<T> implements ErrorResult<T> {
  const _$ErrorResultImpl(this.message);
...
abstract class ErrorResult<T> implements Result<T> {
  const factory ErrorResult(final String message) = _$ErrorResultImpl<T>;
