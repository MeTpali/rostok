...
class FavouriteArticlesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final articles = ref.watch(ArticlesDi.favouriteArticlesProvider);
    ...
    return Scaffold(
      ...
      body: RefreshIndicator.adaptive(
        onRefresh: () async {
          await ref
              .watch(ArticlesDi.favouriteArticlesProvider.notifier)
              .fetchFavorites();
        },
            ...
            child: Column(
              ...
              children: [
                ...
                const FittedBox(
                  ...
                  child: Text(
                    'К сожалению мы не нашли ваших любимых статей. \n Вам ещё не читали статьи? Добро пожаловать в нашу Базу знаний.',
